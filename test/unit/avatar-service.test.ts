...
describe('AvatarService', () => {
  ...
  describe('getAvatarById', () => {
    ...
    it('should throw error when fetch fails', async () => {
      ...
      await expect(service.getAvatarById('test-hash')).rejects.toThrow('Failed to fetch avatar: Not Found');
    });
  ...
  describe('getAvatarByEmail', () => {
    ...
    it('should throw GravatarValidationError for invalid email', async () => {
      ...
      await expect(service.getAvatarByEmail('invalid-email')).rejects.toThrow(GravatarValidationError);
      await expect(service.getAvatarByEmail('invalid-email')).rejects.toThrow('Invalid email format');
    });

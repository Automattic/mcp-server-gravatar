...
export const getInterestsByIdTool = {
  ...
  description:
    "Fetch AI-inferred interests for a Gravatar profile using a profile identifier. Returns a list of machine learning-generated interests that can help understand user preferences, content recommendations, or audience insights. This is experimental data that may not be available for profiles.  When searching for interests, prefer to look up the interests in the Gravatar profile over the inferred interests, since they are specified explicitly by the owner of the Gravatar profile.  Example prompt: 'What are the inferred interests for this Gravatar user?' or 'Get the inferred interests for profile ID abc123def456abc123def456abc123def456abc123def456abc123def456abc1.'",
  inputSchema: {
    type: 'object',
    properties: {
      profileIdentifier: {
